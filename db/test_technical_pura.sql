...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Okt 2021 pada 09.52
...
CREATE TABLE `master_jadwal` (
  ...
  `pegawai_nomor` varchar(100) NOT NULL,
...
--
-- Dumping data untuk tabel `master_jadwal`
--

INSERT INTO `master_jadwal` (`jadwal_id`, `unit_kode`, `pegawai_nomor`, `v1`, `v2`, `v3`, `v4`, `v5`, `v6`, `v7`) VALUES
(1, 'MAT', '0001', '1-3', '4-5', '0-0', '0-0', '9-11', '0-0', '0-0'),
(2, 'MAT', '0002', '0-0', '0-0', '2-6', '0-0', '0-0', '0-0', '0-0'),
(4, 'GJL', '0001', '0-0', '0-0', '12-22', '0-0', '0-0', '0-0', '0-0');
...
--
-- Indeks untuk tabel `kunjungan_pasien`
--
...
--
-- Indeks untuk tabel `master_jadwal`
--
...
--
-- AUTO_INCREMENT untuk tabel `master_jadwal`
--
ALTER TABLE `master_jadwal`
...
--
-- Ketidakleluasaan untuk tabel `kunjungan_pasien`
--
ALTER TABLE `kunjungan_pasien`
